...
$idView = $_GET["id"];
$result = mysqli_query($databaseConn, "SELECT * FROM tbl_layanan WHERE id_layanan = $idView");

if (isset($_POST["back"])){
    header("Location: layanan.php");
}
if (isset($_POST["edit"])){
  header("Loaction: edit-layanan.php");
}
?>
<!DOCTYPE html>
<html
        ...
        <div class="layout-page">
          ...
          <div class="container mt-3">
            ...
            <?php foreach ($result as $dataDbs) : ?>
                <div class="nama mt-2">
                    <label for="nama" class="fw-bold mb-1">Nama Layanan :</label>
                    <input type="text" id="nama" class="form-control" value="<?= $dataDbs["nama_layanan"]; ?>" disabled>
                </div>
                <div class="pesan mt-2">
                    <label for="pesan" class="fw-bold mb-1">Deskripsi Layanan :</label>
                    <textarea class="form-control" name="pesan" id="pesan" cols="30" rows="3" disabled><?= $dataDbs["detail_layanan"]; ?></textarea>
                </div>
