...
$result = mysqli_query($databaseConn, "SELECT * FROM tbl_layanan");
$halaman = "pesan";
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container mt-3">
            <h3 class="fw-bold">Tabel Layanan</h3>
            <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <?php foreach ($result as $dataDbs) : ?>
                      <tr>
                          <td><?= $noUrut ?></td>                          
                          <td><?= $dataDbs["nama_layanan"]; ?></td>
                          <td><i>Lihat Selengkapnya..</i></td>
                          <td>
                            <a class="btn btn-primary btn-sm" href="view-layanan.php?id=<?= $dataDbs["id_layanan"]; ?>">Detail</a>
                            <a class="btn btn-warning btn-sm" href="edit-layanan.php?id=<?= $dataDbs["id_layanan"]; ?>">Edit</a>
                            <a class="btn btn-danger btn-sm" href="delete-layanan.php?id=<?= $dataDbs["id_layanan"]; ?>">Delete</a>
                          </td>
                      </tr>
                      <?php $noUrut++ ?>
                  <?php endforeach; ?>
