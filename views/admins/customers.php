...
$result = mysqli_query($databaseConn, "SELECT * FROM users");
$halaman = "pesan";
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container mt-3">
            <h3 class="fw-bold">Tabel Customers</h3>
                ...
                <tbody>
                  ...
                  <?php foreach ($result as $dataDbs) : ?>
                      <tr>
                          <td><?= $noUrut ?></td>
                          <td><?= $dataDbs["nama"]; ?></td>
                          <td><?= $dataDbs["username"]; ?></td>
                          <td><?= $dataDbs["email"]; ?></td>
                          <td>
                            <a class="btn btn-danger btn-sm" href="delete-customer.php?id=<?= $dataDbs["id"]; ?>">Delete</a>
                          </td>
                      </tr>
                      <?php $noUrut++ ?>
                  <?php endforeach; ?>
