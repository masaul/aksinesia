...
$result = mysqli_query($databaseConn, "SELECT * FROM tbl_admin");
        ...
        <div class="layout-page">
          ...
          <div class="container mt-3">
            ...
            <?php foreach ($result as $dataDbs) : ?>
                <div class="image">
                  <label for="image" class="fw-bold mb-2 d-block">Image :</label>
                  <input type="image" src="../../assets/img/profile/<?= $dataDbs["image"]; ?>" alt="profile" class="img img-rounded" width="150px">
                </div>
                <div class="nama mt-2">
                    <label for="username" class="fw-bold mb-1">Username :</label>
                    <input type="text" id="username" class="form-control" value="<?= $dataDbs["username_admin"]; ?>" disabled>
                </div>
                <div class="email mt-2">
                    <label for="email" class="fw-bold mb-1">Email :</label>
                    <input type="text" class="form-control" id="email" value="<?= $dataDbs["email_admin"]; ?>" disabled>
                </div>
                <div class="button mt-4">  
                    <a class="btn btn-warning w-100" href="edit-settings.php?id=<?=$dataDbs['id_admin'];?>">Edit</a>
                </div>
            <?php endforeach; ?>
          </div>
        </div>
