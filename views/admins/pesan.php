...
$result = mysqli_query($databaseConn, "SELECT * FROM tbl_contact");
$halaman = "pesan";
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container mt-3">
            <h3 class="fw-bold">Tabel Pesan</h3>
                ...
                <tbody>
                  ...
                  <?php foreach ($result as $dataDbs) : ?>
                      <tr>
                          ...
                          <td>
                            <a class="btn btn-primary btn-sm" href="view-pesan.php?id=<?= $dataDbs["id_pesan"]; ?>">Detail</a>
                            <a class="btn btn-danger btn-sm" href="delete-pesan.php?id=<?= $dataDbs["id_pesan"]; ?>">Delete</a>
                          </td>
                      </tr>
                      <?php $noUrut++ ?>
                  <?php endforeach; ?>
