...
$halaman = "dashboard";
$queryJumlahUser = mysqli_query($databaseConn, "SELECT * FROM users");
$queryJumlahKontak = mysqli_query($databaseConn, "SELECT * FROM tbl_contact");
$queryJumlahKonsul = mysqli_query($databaseConn, "SELECT * FROM tbl_consult");
$jumlahUser = mysqli_num_rows($queryJumlahUser);
$jumlahKontak = mysqli_num_rows($queryJumlahKontak);
$jumlahKonsul = mysqli_num_rows($queryJumlahKonsul);
            ...
            <div class="row">
              <div class="col-md-6 col-xl-4">
                <div class="card bg-danger text-white mb-3">
                  <div class="card-header text-center title-data">Jumlah Pesan Kontak</div>
                  <div class="card-body count-data">
                    <h1 class="card-title text-white text-center"><?= $jumlahKontak; ?></h1>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-xl-4">
                <div class="card bg-warning text-white mb-3">
                  <div class="card-header text-center title-data">Jumlah Pesan Konsultasi</div>
                  <div class="card-body count-data">
                    <h1 class="card-title text-white text-center"><?= $jumlahKonsul; ?></h1>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-xl-4">
                <div class="card bg-primary text-white mb-3">
                  <div class="card-header text-center title-data">Jumlah User</div>
                  <div class="card-body count-data">
                    <h1 class="card-title text-white text-center"><?= $jumlahUser; ?></h1>
                  </div>
                </div>
              </div>
            </div>
