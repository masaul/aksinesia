...
$result = mysqli_query($databaseConn, "SELECT * FROM kontak");
$halaman = "pesan";
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container mt-3">
            <h3 class="fw-bold">Data Kontak</h3>
            <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <?php foreach ($result as $dataDbs) : ?>
                      <tr>
                          <td><?= $noUrut ?></td>                          
                          <td><?= $dataDbs["telepon"]; ?></td>
                          <td><?= $dataDbs["whatsapp"]; ?></td>
                          <td><?= $dataDbs["email"]; ?></td>
                          <td><?= $dataDbs["alamat"]; ?></td>
                          <td>
                            <a class="btn btn-warning" href="edit-kontak.php?id=<?= $dataDbs["id_kontak"]; ?>">Edit</a>
                          </td>
                      </tr>
                      <?php $noUrut++ ?>
                  <?php endforeach; ?>
